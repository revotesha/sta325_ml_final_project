...
sum(diag(table(prunetree.pred, deathrate.test)))/36 # correctly classified ~38.9%
```
...
sum(diag(table(boost.pred, deathrate.test)))/36 # correctly classified ~55.5%
```

...
```{r}
summary(fit.select)
cumu.logistic.select = nnet::multinom(est_death_rate_cat ~ pharmacy_num_ptt + most_dist_channel + 
...
knitr::kable(cumu.logistic.select%>% tidy(conf.int=TRUE),format="html",digits=3)
```

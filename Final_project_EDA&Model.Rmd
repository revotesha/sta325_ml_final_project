...
ordnet1 <- ordinalNet(x, y, family="cumulative", link="logit",
                   parallelTerms=TRUE, nonparallelTerms=FALSE, alpha=1, standardize = TRUE)
coef.ordinalNet(ordnet1, matrix = TRUE, whichLambda = FALSE, criteria="aic")
summary(ordnet1)
coef(ordnet1, matrix=TRUE, whichLambda = NULL, criteria="aic")
set.seed(0813)

...
ggplot(data = train_oh_wv_2012, aes(x = est_death_rate_cat, y = Population)) + 
  geom_boxplot()+ 
  title(xlab = "Estimated Death Rate Category", ylab = "County Population",
        main = "Death Rate Category vs County Population") 

ggplot(data = train_oh_wv_2012, aes(x = est_death_rate_cat, y = pharmacy_num_ptt)) + 
  geom_boxplot() + 
  title(xlab = "Estimated Death Rate Category", 
        ylab = "Number of Pharmacies", 
...
ggplot(data = train_oh_wv_2012, aes(x = est_death_rate_cat, y = distr_num_ptt)) +
  geom_boxplot() +
  labs(xlab = "Death Rate Category", y = "Number of manufacturers involved",
...
```{r}
# number of manufactueres (ptt) vs total active weight of opioids per person by number of pharmacies (ptt)

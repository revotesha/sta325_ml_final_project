...
for(idx in thirty_plus){
  random_death_rate = round(runif(1, 30, 957), 0) # this works not but I think we could
  # also use another distribution that reflects distribution of adjusted death rates in
  # wv. I (revo) can look into this.
